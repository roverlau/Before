...
@interface ResultPlanDetailController ()<UIScrollViewDelegate>
...
@implementation ResultPlanDetailController
...
- (void)share
{
    [UMSocialSnsService presentSnsIconSheetView:self appKey:nil shareText:[NSString stringWithFormat:@"%@ : %@",self.title,[NSString stringWithFormat:@"%@%@%@",ResultPlanPrefix_URL,_resultPlanId,ResultPlanSuffix_URL]]shareImage:nil shareToSnsNames:@[UMShareToSina,UMShareToQzone] delegate:nil];
}

- (void)showContent
{
    self.request = [NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@%@",ResultPlanPrefix_URL,_resultPlanId,ResultPlanSuffix_URL]]];
