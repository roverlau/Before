...
@interface LotteriesDetailController ()<UIScrollViewDelegate>
...
@implementation LotteriesDetailController
...
- (void)initUI
{
    ...
    [shareBtn addTarget:self action:@selector(goBack) forControlEvents:UIControlEventTouchUpInside];
