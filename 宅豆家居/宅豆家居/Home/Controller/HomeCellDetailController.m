...
@interface HomeCellDetailController ()<UIScrollViewDelegate>
...
@implementation HomeCellDetailController
...
- (void)share
{
    [UMSocialSnsService presentSnsIconSheetView:self appKey:nil shareText:[NSString stringWithFormat:@"%@ : %@",self.title,[NSString stringWithFormat:@"%@%@%@",HomeCellDetailPrefix_URL,self.cellId,HomeCellDetailSuffix_URL]]shareImage:nil shareToSnsNames:@[UMShareToSina,UMShareToQzone] delegate:nil];
}

- (void)showContent
{
    self.request = [NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@%@",HomeCellDetailPrefix_URL,self.cellId,HomeCellDetailSuffix_URL]]];
